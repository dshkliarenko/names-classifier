...
from scripts.train import n_hidden, n_categories, n_letters, all_categories, lineToTensor, RNN, WEIGHTS_PATH
...
def predict(name, n_predictions: int, weights_file: Path):
    ...
    # n_predictions should not exceed number of available categories
    n_predictions = min(n_predictions, output.data.shape[1])
...
if __name__ == "__main__":
    ...
    parser.add_argument("-w", type=Path, default=WEIGHTS_PATH, help="path to model weights")
